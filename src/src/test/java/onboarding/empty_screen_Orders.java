...
public class empty_screen_Orders extends base {
	

	
	@Test(priority = 1, groups = "Sign up")
	public void empty_screen_Orders() throws InterruptedException 
	{
		...
		driver.findElement(By.name("Orders")).click();
		

		if (driver.findElements(By.id("in.interactive.luckystars:id/tv_noOrderMsg")).size() == 1)
		{
			driver.findElement(By.id("in.interactive.luckystars:id/tv_noOrderMsg")).click();
