...
public class change_number_button extends base
{
	
@Test(priority = 1, groups = "Sign up")
public void change_number_button() throws InterruptedException 
	{
	...
	try 
	 ...
	 catch (MalformedURLException e) 
	 {
		...
		if (driver.findElements(By.id("changebtn")).size() == 1)
		{
		//	takeScreenShot();
