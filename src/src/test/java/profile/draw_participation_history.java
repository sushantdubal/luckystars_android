...
public class draw_participation_history extends base
{


	@Test(priority = 1, groups = "Left menu")
	public void draw_participation_history() throws InterruptedException 
	{
		...
		driver.findElement(By.id("tv_draw_history")).click();
