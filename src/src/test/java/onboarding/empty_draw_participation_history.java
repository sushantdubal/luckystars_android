...
public class empty_draw_participation_history extends base
{
	
	@Test(priority = 1, groups = "Sign up")
	public void empty_draw_participation_history() throws InterruptedException 
	
	{
		...
		driver.findElement(By.id("iv_settings")).click();
   	    ...
   	    driver.findElement(By.name("Draw participation History")).click();
   	    
	
		if (driver.findElements(By.id("iv_draw")).size() == 1)
		{
			
			driver.findElement(By.id("iv_draw")).click();
