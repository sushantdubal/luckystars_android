...
import config.base;
public class pd_valid_birthdate extends base
{
	
	@Test(priority = 1, groups = "Profile")
	public void pd_valid_birthdate() throws InterruptedException 
	{
	   ...
	   driver.findElement(By.id("et_pincode")).click();
		...
		if (driver.findElements(By.name("Personal Details")).size() == 1)
		{
