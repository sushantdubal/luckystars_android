...
public class transaction_history extends base
{
	

	@Test(priority = 1, groups = "Left menu")
	public void transaction_history() throws InterruptedException 
	{
		try 
		 {
			//call setup method
		...
		if (driver.findElements(By.id("tv_trans_history")).size() == 1)
		{

			driver.findElement(By.id("tv_trans_history")).click();
