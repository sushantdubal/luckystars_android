...
public class redeemstars extends base
{
	
	@Test(priority = 1, groups = "Stars dashboard")
	public void redeemstars() throws InterruptedException 
	{
		try 
		 {
			//call setup method
		...
		if (driver.findElements(By.id("in.interactive.luckystars:id/tv_view_all")).size() == 1)
		{
