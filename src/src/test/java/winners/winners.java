...
public class winners  extends base
{
	
	
	@Test(priority = 1, groups = "Winners")
	public void winners() throws InterruptedException 
	{
		...
		if (driver.findElements(By.name("Winners")).size() == 1)
		{
