...
import config.base;
public class personal_d_invalid_birthdate extends base
{
	
	@Test(priority = 1, groups = "Profile")
	public void personal_d_invalid_birthdate() throws InterruptedException 
	{
		try 
		 {
			//call setup method
	   ...
	   // driver.findElement(By.id(lp.changeDate)).click();
		...
		driver.findElement(By.name("You should be at least 18 years old.")).click();
