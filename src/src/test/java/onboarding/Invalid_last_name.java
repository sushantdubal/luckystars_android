...
public class Invalid_last_name extends base
{

		
	@Test(priority = 1, groups = "Sign up")
		public void Invalid_last_name() throws InterruptedException 
		{
			try 
			 {
				//call setup method
			...
			//Enters last name
			driver.findElement(By.id("et_last_name")).sendKeys("D");
			...
			if (driver.findElements(By.name("Invalid Last Name")).size() == 1)
