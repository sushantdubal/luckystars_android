...
public class stars_transfer extends base
{
	
	@Test(priority = 1, groups = "Stars dashboard")
	public void stars_transfer() throws InterruptedException 
	{
		try 
		 {
			//call setup method
		...
		/*if (driver.findElements(By.id("in.interactive.luckystars:id/layoutTransfer")).size() == 1)
		{
			driver.findElement(By.id("in.interactive.luckystars:id/layoutTransfer")).click();
			
			driver.findElement(By.id("in.interactive.luckystars:id/et_mobile_number")).sendKeys("9561192140");
			
			driver.findElement(By.id("in.interactive.luckystars:id/et_coins")).sendKeys("1");
