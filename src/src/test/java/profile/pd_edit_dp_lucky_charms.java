...
public class pd_edit_dp_lucky_charms extends base
{
	
	

	@Test(priority = 1, groups = "Profile")
	public void pd_edit_dp_lucky_charms() throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.GridView[1]/android.widget.LinearLayout[6]/android.widget.ImageView[1]")).click();
