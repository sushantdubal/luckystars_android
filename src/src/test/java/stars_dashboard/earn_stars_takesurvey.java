...
public class earn_stars_takesurvey extends base
{
	
	@Test(priority = 1, groups = "Stars dashboard")
	public void earn_stars_takesurvey() throws InterruptedException 
	{
		try 
		 {
			//call setup method
		...
		/*driver.findElement(By.name("Take Survey")).click();
